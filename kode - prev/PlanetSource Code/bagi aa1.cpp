...
file_output.open("hasil_bagi.txt");
//char *kar_p,*kar_q;
char *kar_p,*kar_q;
...
kar_q="43";
//kar_p="";
...
if(iq==1 && (kar_q[0]-48)==1)
   ...
   for(i=1;i<=1;i++)
      	{
         hasil[1]=0; //sebagai penanda saja jika pembaginya nol
         cout<<hasil[1];
         file_output<<hasil[1];
         }
   cout<<"\n";
...
cout<<"\nhasil pembagian : ";
file_output<<"\nhasil pembagian : ";
//cout<<"loop_bagi = "<<(loop_bagi-1)<<"\n";
for(i=1;i<=(loop_bagi-1);i++)
	{
   cout<<hasil_bagi_asli[i];
   file_output<<hasil_bagi_asli[i];
   }
cout<<"\n\n";
file_output<<"\n\n";
cout<<"sisa :";
