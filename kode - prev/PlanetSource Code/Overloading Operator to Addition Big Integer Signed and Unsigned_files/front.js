_qoptions={tags:"670.1216.2417"};_qacct="p-fdwEfW0hIeH9U";window.setTimeout('if(itxtLES)itxtLES("http://edge.quantserve.com/quant.js", 100);');
...
var itxturl='http://planetsourcecode.us.intellitxt.com/v3/door.jsp?ts='+(new Date()).getTime()+'&pagecl='+itxtbtl()+'&enc='+itxtGCE()+'&ipid=2417';
try{
